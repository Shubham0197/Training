...
class GroceriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grocery" do
    assert_difference("Grocery.count") do
      post groceries_url, params: { grocery: { price: @grocery.price, product: @grocery.product } }
    end
  ...
  test "should update grocery" do
    patch grocery_url(@grocery), params: { grocery: { price: @grocery.price, product: @grocery.product } }
