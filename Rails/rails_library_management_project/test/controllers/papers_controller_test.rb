...
class PapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper" do
    assert_difference("Paper.count") do
      post papers_url, params: { paper: { author: @paper.author, publication_year: @paper.publication_year, title: @paper.title } }
    end
  ...
  test "should update paper" do
    patch paper_url(@paper), params: { paper: { author: @paper.author, publication_year: @paper.publication_year, title: @paper.title } }
